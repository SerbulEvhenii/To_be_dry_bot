...
inline_btn_menu_notify = telebot.types.InlineKeyboardButton('Выбор времени уведомлений', callback_data='menu_btn_notify')
...
inline_kb_all_times = telebot.types.InlineKeyboardMarkup().add(inline_btn_1, inline_btn_2, inline_btn_3, inline_btn_4,
                                                               ...
                                                               inline_btn_9, inline_btn_10, inline_btn_11, inline_btn_12,
                                                               inline_btn_13, inline_btn_14, inline_btn_15, inline_btn_16,
